...
cliff.func @rotation(%arg0 : tensor<NUM_ELSx!cliff.line<euclidean, true, #space>>, %arg1 : tensor<NUM_ELSx!cliff.scalar<#space>>, %pointer : !clg.ptr<f32>) {

    %0 = cliff.rotate %arg0, %arg1 :
        tensor<NUM_ELSx!cliff.line<euclidean, true, #space>> *
