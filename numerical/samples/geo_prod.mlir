...
cliff.func @geo_prod(%arg0 : !clg.ptr<f32>, %arg1 : !clg.ptr<f32>, %pointer : !clg.ptr<f32>) {
    ...
    %t0 = clg.load %arg0 : !clg.ptr<f32> -> tensor<64x!cliff.multivector<MASK_A, unknown, f32, #space>, #layout>
    %t1 = clg.load %arg1 : !clg.ptr<f32> -> tensor<64x!cliff.multivector<MASK_B, unknown, f32, #space>, #layout>
    ...
    clg.store %pointer, %1 : !clg.ptr<f32>, tensor<64x!cliff.multivector<MASK_C, unknown, f32, #space>, #layout>
    cliff.ret
}
...
cliff.func @complete_rotation(%x_ptr : !clg.ptr<f32>, %y_ptr : !clg.ptr<f32>, %angle_2_ptr : !clg.ptr<f32>, %store_ptr : !clg.ptr<f32>) {
    
    %x = clg.load %x_ptr : !clg.ptr<f32> -> tensor<64x!cliff.multivector<105, unknown, f32, #space>, #layout>
    %y = clg.load %y_ptr : !clg.ptr<f32> -> tensor<64x!cliff.multivector<105, unknown, f32, #space>, #layout>
    %angle_2 = clg.load %angle_2_ptr : !clg.ptr<f32> -> tensor<64x!cliff.multivector<1, unknown, f32, #space>, #layout>
    ...
    clg.store %store_ptr, %out : !clg.ptr<f32>, tensor<64x!cliff.multivector<105, unknown, f32, #space>, #layout>
    cliff.ret
}